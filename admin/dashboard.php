...
$total_users = mysqli_fetch_assoc(mysqli_query($conn, $sql))['count'];

$sql = "SELECT COUNT(*) as count FROM medicines";
$total_medicines = mysqli_fetch_assoc(mysqli_query($conn, $sql))['count'];

$sql = "SELECT SUM(total_amount) as total FROM bills";
$total_sales = mysqli_fetch_assoc(mysqli_query($conn, $sql))['total'] ?? 0;
...
$sql = "SELECT COUNT(*) as count FROM medicines WHERE expiry_date < CURDATE()";
$expired_count = mysqli_fetch_assoc(mysqli_query($conn, $sql))['count'];
?>
...
<div class="admin-wrap">
        ...
        <h1>
            <svg class="header-icon" fill="none" viewBox="0 0 24 24" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round"
                      d="M3 3v18h18M7 14v4M11 10v8M15 6v12"/>
            </svg>
            Admin Overview
        </h1>
    ...
    <div class="kpi-panel">
        ...
        <div class="kpi-row">
            ...
            <div class="kpi-value"><?php echo format_currency($total_sales); ?></div>
            <div class="kpi-status">Revenue</div>
        </div>
        ...
        <div class="kpi-row">
            ...
            <div class="kpi-title">Expired Medicines</div>
            <div class="kpi-value"><?php echo $expired_count; ?></div>
            <div class="kpi-status danger">Critical</div>
        </div>
    </div>
